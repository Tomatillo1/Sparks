...
<div class="globalMessage">
    <div class="header">
        ...
        <div class="whichCoach">
            <img src="/coach/coach-4.jpeg" alt="coach4">
            <h1>Grégory</h1>
        </div>
    </div>
    <div class="allMessages">
        <p class="messageTo">Bonjour Grégory, je vous contacte car j’aimerais savoir comment mes salariés peuvent
            accéder à leurs résultats et à leur progression.<br> Merci et bonne journée à vous.</p>
        <p class="messageFrom">Bonjour, pouvez-vous m’en dire plus sur votre problème ?<br>Grégory.</p>
...
<div class="messageBottom">
    <Message bind:value={messageValue} sendMessage={sendMessage4}/>
</div>
