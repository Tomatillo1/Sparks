<script>
    ...
    function sendMessage3() {
        ...
        arrayOfMessagesStore.update((old) => {
            const idx = old.findIndex((coach) => coach.name === 3);
...
<div class="globalMessage">
    <div class="header">
        ...
        <div class="whichCoach">
            <img src="/coach/coach-3.jpeg" alt="coach3">
            <h1>Éric</h1>
        </div>
    </div>
    <div class="allMessages">
        {#each $arrayOfMessagesStore[2].messages as message}
...
<div class="messageBottom">
    <Message bind:value={messageValue} sendMessage={sendMessage3}/>
</div>
